...
<head>
  ...
  <title>Payment Receipt — ${partner.name} — Mizark Global</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      <div class="logo-row">
        ...
        <div>
          ...
          <div class="logo-sub">Admin — Receipt Copy</div>
        </div>
      </div>
    ...
    <div class="body">
      <div class="admin-badge" style="margin-bottom:24px;">Admin Copy — Not for Distribution</div>
      ...
      <div class="footer-note">
        <strong>Note:</strong> This receipt confirms receipt of investment capital from ${partner.name} into the Mizark Global Musharakah Partnership. Equity: ${Number(partner.equity_pct).toFixed(3)}% of net profits. Capital is returned at term end subject to business performance.
      </div>
