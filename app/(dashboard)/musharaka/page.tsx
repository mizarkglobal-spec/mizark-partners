    ...
    <div className="p-6 sm:p-8 space-y-8 max-w-4xl">
      ...
      <div>
        <div className="inline-flex items-center gap-2 bg-[#f0fdf4] border border-[#bbf7d0] rounded-full px-4 py-1.5 mb-4">
          <span className="text-[#40916c] text-xs font-semibold uppercase tracking-widest">Islamic Finance</span>
        </div>
        <h1 className="text-3xl font-bold text-[#111827] mb-2">Understanding Musharaka</h1>
        <p className="text-gray-500 text-base leading-relaxed">
          The Shariah-compliant foundation of your Mizark Global partnership — a scholarly guide to Islamic joint venture investment.
        </p>
      </div>
      ...
      <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8">
        ...
        <div className="bg-[#f0fdf4] border border-[#d1fae5] rounded-xl p-4">
          <p className="text-[#065f46] text-sm font-medium">
            In our structure: you contribute capital, Mizark Global contributes capital, management, and labour. Profits are distributed 30% to all partners (proportional to equity) and 70% reinvested in operations. Losses, if any, reduce capital proportionally.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            {
              title: "Shirkat al-Amwal",
              arabic: "شركة الأموال",
              desc: "Capital partnership — two or more parties each contribute monetary capital. This is our structure. Each partner is a co-owner in proportion to their contribution.",
              active: true,
            },
            {
              title: "Shirkat al-A'mal",
              arabic: "شركة الأعمال",
              desc: "Labour/service partnership — partners contribute skills and work rather than capital. Common among craftsmen and professionals. Also called Shirkat al-Abdan.",
              active: false,
            },
            {
              title: "Shirkat al-Wujooh",
              arabic: "شركة الوجوه",
              desc: "Goodwill/credit partnership — partners use their reputation and creditworthiness to acquire goods on credit, then sell them for profit. No capital contributed.",
              active: false,
            },
            {
              title: "Musharaka Mutanaqisah",
              arabic: "مشاركة متناقصة",
              desc: "Diminishing Musharaka — the bank/financier gradually transfers their ownership share to the client over time. Widely used in Islamic home finance.",
              active: false,
            },
          ].map((t) => (
            <div
              key={t.title}
              className={`rounded-xl p-4 border ${t.active ? "bg-[#f0fdf4] border-[#bbf7d0]" : "bg-gray-50 border-gray-100"}`}
            >
              <div className="flex items-start justify-between gap-2 mb-2">
                <h3 className={`font-semibold text-sm ${t.active ? "text-[#065f46]" : "text-[#111827]"}`}>{t.title}</h3>
                {t.active && (
                  <span className="bg-[#40916c] text-white text-[10px] px-2 py-0.5 rounded-full font-semibold flex-shrink-0">Our Structure</span>
                )}
              </div>
              <div className={`text-base mb-2 font-arabic ${t.active ? "text-[#40916c]" : "text-gray-400"}`}>{t.arabic}</div>
      ...
      <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#f0fdf4] border border-[#d1fae5] rounded-xl p-5">
            <div className="text-right text-xl leading-loose text-[#0f2a1e] font-arabic mb-3 dir-rtl" dir="rtl">
              وَإِنَّ كَثِيرًا مِّنَ الْخُلَطَاءِ لَيَبْغِي بَعْضُهُمْ عَلَىٰ بَعْضٍ إِلَّا الَّذِينَ آمَنُوا وَعَمِلُوا الصَّالِحَاتِ
            </div>
            <p className="text-[#065f46] text-sm leading-relaxed mb-2">
              &ldquo;And indeed many partners oppress one another — except those who believe and do righteous deeds, and few are they.&rdquo;
            </p>
            <div className="text-[#40916c] text-xs font-semibold">Surah Sad (38:24)</div>
          ...
          <div className="bg-[#f0fdf4] border border-[#d1fae5] rounded-xl p-5">
            <div className="text-right text-xl leading-loose text-[#0f2a1e] font-arabic mb-3" dir="rtl">
              يَا أَيُّهَا الَّذِينَ آمَنُوا أَوْفُوا بِالْعُقُودِ
            </div>
            <p className="text-[#065f46] text-sm leading-relaxed mb-2">
              &ldquo;O you who believe! Fulfil your contracts/obligations.&rdquo;
            </p>
            <div className="text-[#40916c] text-xs font-semibold">Surah Al-Ma&apos;idah (5:1)</div>
            <p className="text-gray-500 text-xs mt-2">
          ...
          <div className="bg-[#f0fdf4] border border-[#d1fae5] rounded-xl p-5">
            ...
            <p className="text-[#065f46] text-sm leading-relaxed mb-2">
              &ldquo;O you who believe! Do not consume one another&apos;s wealth unjustly — except it be a trade by mutual consent among you.&rdquo;
            </p>
            <div className="text-[#40916c] text-xs font-semibold">Surah An-Nisa (4:29)</div>
            <p className="text-gray-500 text-xs mt-2">
              This verse establishes two foundational principles: prohibition of consuming wealth unjustly, and the permissibility of trade and commercial dealings conducted with mutual consent. Musharaka embodies both.
            </p>
          </div>
      ...
      <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#fffbeb] border border-[#fde68a] rounded-xl p-5">
            <div className="text-right text-lg leading-loose text-[#92400e] font-arabic mb-3" dir="rtl">
            ...
            <p className="text-gray-500 text-xs mt-3 leading-relaxed">
              Narrated by Abu Hurairah (رضي الله عنه) and authenticated by Al-Hakim, Ibn Hibban, and graded Sahih by Sheikh Al-Albani. This Hadith Qudsi (divine narration in the Prophet&apos;s words) is the primary textual evidence for Musharaka — Allah Himself blesses faithful partnerships and withdraws His blessing upon betrayal.
            </p>
          </div>
          ...
          <div className="bg-[#fffbeb] border border-[#fde68a] rounded-xl p-5">
            ...
            <p className="text-gray-500 text-xs mt-3 leading-relaxed">
              Partnership in Islam is not merely a commercial arrangement — it is an act of worship when conducted with honesty and integrity. The Prophet (ﷺ) himself engaged in business partnerships before Prophethood, including with Khadijah (رضي الله عنها), demonstrating the nobility of this structure.
            </p>
          </div>
      ...
      <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8">
        ...
        <p className="text-gray-600 leading-relaxed mb-5">
          There is <strong className="text-[#111827]">Ijma&apos;</strong> (scholarly consensus) among all four major schools of Islamic jurisprudence on the permissibility of Musharaka:
        </p>
        ...
        <div className="bg-gray-50 border border-gray-100 rounded-xl p-5 space-y-3">
          ...
          <div className="space-y-2">
            <div>
              <span className="text-[#0f2a1e] font-semibold text-sm">Dr. Muhammad Taqi Usmani</span>
              <span className="text-gray-400 text-xs ml-2">(Former Chief Justice, Pakistan Shariah Court)</span>
              <p className="text-gray-500 text-xs mt-0.5 leading-relaxed">
                In <em>An Introduction to Islamic Finance</em>: &ldquo;Musharaka is the most ideal form of Islamic financing and is closest to the spirit of Islam...&rdquo; Dr. Usmani is the foremost contemporary authority on Islamic commercial law.
              </p>
            </div>
            <div>
              <span className="text-[#0f2a1e] font-semibold text-sm">Ibn Qudamah al-Maqdisi</span>
              <span className="text-gray-400 text-xs ml-2">(Al-Mughni, 12th century CE)</span>
              <p className="text-gray-500 text-xs mt-0.5">
                &ldquo;Partnership in trade is permissible by the consensus of the scholars.&rdquo; — Al-Mughni, Vol. 5.
              </p>
            </div>
            <div>
              <span className="text-[#0f2a1e] font-semibold text-sm">Ibn Rushd (Averroes)</span>
              <span className="text-gray-400 text-xs ml-2">(Bidayat al-Mujtahid)</span>
              <p className="text-gray-500 text-xs mt-0.5">
      ...
      <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8">
        ...
        <p className="text-gray-500 text-sm mb-5">
          For a Musharaka to be Shariah-compliant, the following conditions must be met. Our partnership is structured to fulfil all of them:
        </p>
        <div className="space-y-3">
          {[
            {
              condition: "Capital must be real and present",
              detail: "Capital contributions must be actual monetary funds (or tangible assets) — not promises, debt, or future obligations. Our partners contribute verified capital before activation.",
              met: true,
            },
            {
              condition: "Profit sharing ratio agreed upfront",
              detail: "The profit sharing ratio must be specified as a percentage of actual profit — never as a fixed lump sum. Our agreement specifies 30% of net profit distributed to all partners proportionally to equity.",
              met: true,
            },
            {
              condition: "Losses borne according to capital ratio",
              detail: "Losses cannot be allocated arbitrarily. They must be borne in exact proportion to each partner's capital contribution. This is non-negotiable in all madhabs.",
              met: true,
            },
            {
              condition: "Business activity must be Halal",
              detail: "The partnership enterprise must engage in Shariah-compliant activities. Mizark Global operates Leadash (SaaS) and an online academy — both are permissible businesses with no interest, alcohol, or prohibited products.",
              met: true,
            },
            {
              condition: "No guaranteed return (no Riba)",
              detail: "Returns cannot be guaranteed or fixed. Profit depends on actual business performance. Partners share in real risk — this is the fundamental distinction from interest-based lending.",
              met: true,
            },
            {
              condition: "Mutual consent (Rida)",
              detail: "All partners must enter the agreement voluntarily and with full informed consent. Our agreement process ensures partners review, understand, and sign the full agreement before activation.",
              met: true,
            },
          ].map((c) => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                ...
                { label: "Term", value: "3 years from activation" },
                { label: "Profit Share to Partners", value: "30% of quarterly net profit" },
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-[#f0fdf4] border border-[#d1fae5] rounded-xl p-3">
                ...
                <p className="text-[#065f46] text-xs">Quarterly net profit calculated. 30% allocated to all partners proportionally to equity stake.</p>
              </div>
      ...
      <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8">
        ...
        <div className="space-y-4">
          {[
            {
              q: "Is the profit truly variable, or is a minimum return guaranteed?",
              a: "Profit is genuinely variable. There is no guaranteed minimum return. If the business makes no profit in a quarter, no distribution is made. If there is a loss, your capital is reduced proportionally. This real risk-sharing is what makes Musharaka Halal.",
            },
            {
              q: "What happens to my capital if the business closes?",
              a: "Your capital is at risk — as it would be in any equity investment. Assets are liquidated, liabilities paid, and remaining capital distributed to partners proportionally. This is disclosed fully in your partnership agreement.",
            },
            {
              q: "Can I withdraw my capital early?",
              a: "The partnership term is 3 years. Early exit may be possible by arrangement (transfer of your stake to another party) but is not guaranteed. Capital is tied up for the partnership term — this is a feature, not a bug, as it protects the business from sudden capital withdrawals.",
            },
            {
              q: "Has this structure been reviewed by a Shariah scholar?",
              a: "Our partnership structure and agreement were drafted in accordance with established Musharaka principles from classical fiqh texts. Partners are encouraged to seek their own Shariah advisor's opinion if they require personal certification.",
            },
            {
              q: "Why 30% profit distribution and not more?",
              a: "The 30% distribution reflects the need to reinvest in business growth (product development, marketing, operations). A sustainable business that grows also benefits partners through appreciation of the underlying equity. This ratio is disclosed and agreed upfront — which is all that Shariah requires.",
            },
            {
              q: "Is there zakat due on my partnership stake?",
              a: "Generally, zakat is due on business assets (working capital, receivables) at the nisab threshold. Consult your own Shariah advisor or local imam for a ruling specific to your situation. We recommend treating your equity stake as a trade asset for zakat calculation purposes.",
            },
          ].map((item) => (
